...
# GH #3058
{
    is_run q|use v6.d; our constant &my-not = CORE::<&not>; print "ALIAS: ", my-not(False)|,
            { out => q<ALIAS: True> },
            "CORE symbols are available at compile-time";
    is_run q|use v6.d; EVAL q«our constant &evaled-not = CORE::<&not>; print "EVAL: ", evaled-not(False)»|,
            { out => q<EVAL: True> },
            "CORE symbols are available at compile-time inside EVAL";
    is_run q|use v6.d; BEGIN our constant &begin-not = CORE::<&not>; print "BEGIN: ", begin-not(False)|,
            { out => q<BEGIN: True> },
            "CORE symbols are available at compile-time in BEGIN";
    is_run q|use v6.d; BEGIN EVAL q«our constant &begin-evaled-not = CORE::<&not>; print "BEGIN EVAL: ", begin-evaled-not(False)»|,
