...
is Uni.new(0x1F46F, 0x200D, 0x2642, 0xFE0F).Str.chars, 1, "Codes: ⟅0x1F46F, 0x200D, 0x2642, 0xFE0F⟆ 👯‍♂️ men with bunny ears partying";
## 1F46F 200D 2642                            ; non-fully-qualified # 👯‍♂ men with bunny ears partying # emoji-test.txt line #1058 Emoji version 4.0
is Uni.new(0x1F46F, 0x200D, 0x2642).Str.chars, 1, "Codes: ⟅0x1F46F, 0x200D, 0x2642⟆ 👯‍♂ men with bunny ears partying";
## 1F46F 200D 2640 FE0F                       ; fully-qualified     # 👯‍♀️ women with bunny ears partying # emoji-test.txt line #1059 Emoji version 4.0
is Uni.new(0x1F46F, 0x200D, 0x2640, 0xFE0F).Str.chars, 1, "Codes: ⟅0x1F46F, 0x200D, 0x2640, 0xFE0F⟆ 👯‍♀️ women with bunny ears partying";
## 1F46F 200D 2640                            ; non-fully-qualified # 👯‍♀ women with bunny ears partying # emoji-test.txt line #1060 Emoji version 4.0
is Uni.new(0x1F46F, 0x200D, 0x2640).Str.chars, 1, "Codes: ⟅0x1F46F, 0x200D, 0x2640⟆ 👯‍♀ women with bunny ears partying";
## 1F574 FE0F                                 ; fully-qualified     # 🕴️ man in business suit levitating # emoji-test.txt line #1061 Emoji version 4.0
is Uni.new(0x1F574, 0xFE0F).Str.chars, 1, "Codes: ⟅0x1F574, 0xFE0F⟆ 🕴️ man in business suit levitating";
## 1F574 1F3FB                                ; fully-qualified     # 🕴🏻 man in business suit levitating: light skin tone # emoji-test.txt line #1062 Emoji version 4.0
#?rakudo.moar todo 'All of Unicode Emoji NYI in MoarVM'
is Uni.new(0x1F574, 0x1F3FB).Str.chars, 1, "Codes: ⟅0x1F574, 0x1F3FB⟆ 🕴🏻 man in business suit levitating: light skin tone";
...
#?rakudo.moar todo 'All of Unicode Emoji NYI in MoarVM'
is Uni.new(0x1F574, 0x1F3FC).Str.chars, 1, "Codes: ⟅0x1F574, 0x1F3FC⟆ 🕴🏼 man in business suit levitating: medium-light skin tone";
## 1F574 1F3FD                                ; fully-qualified     # 🕴🏽 man in business suit levitating: medium skin tone # emoji-test.txt line #1064 Emoji version 4.0
#?rakudo.moar todo 'All of Unicode Emoji NYI in MoarVM'
is Uni.new(0x1F574, 0x1F3FD).Str.chars, 1, "Codes: ⟅0x1F574, 0x1F3FD⟆ 🕴🏽 man in business suit levitating: medium skin tone";
...
#?rakudo.moar todo 'All of Unicode Emoji NYI in MoarVM'
is Uni.new(0x1F574, 0x1F3FE).Str.chars, 1, "Codes: ⟅0x1F574, 0x1F3FE⟆ 🕴🏾 man in business suit levitating: medium-dark skin tone";
## 1F574 1F3FF                                ; fully-qualified     # 🕴🏿 man in business suit levitating: dark skin tone # emoji-test.txt line #1066 Emoji version 4.0
#?rakudo.moar todo 'All of Unicode Emoji NYI in MoarVM'
is Uni.new(0x1F574, 0x1F3FF).Str.chars, 1, "Codes: ⟅0x1F574, 0x1F3FF⟆ 🕴🏿 man in business suit levitating: dark skin tone";
...
is Uni.new(0x1F590, 0xFE0F).Str.chars, 1, "Codes: ⟅0x1F590, 0xFE0F⟆ 🖐️ raised hand with fingers splayed";
## 1F590 1F3FB                                ; fully-qualified     # 🖐🏻 raised hand with fingers splayed: light skin tone # emoji-test.txt line #1591 Emoji version 4.0
is Uni.new(0x1F590, 0x1F3FB).Str.chars, 1, "Codes: ⟅0x1F590, 0x1F3FB⟆ 🖐🏻 raised hand with fingers splayed: light skin tone";
...
is Uni.new(0x1F590, 0x1F3FC).Str.chars, 1, "Codes: ⟅0x1F590, 0x1F3FC⟆ 🖐🏼 raised hand with fingers splayed: medium-light skin tone";
## 1F590 1F3FD                                ; fully-qualified     # 🖐🏽 raised hand with fingers splayed: medium skin tone # emoji-test.txt line #1593 Emoji version 4.0
is Uni.new(0x1F590, 0x1F3FD).Str.chars, 1, "Codes: ⟅0x1F590, 0x1F3FD⟆ 🖐🏽 raised hand with fingers splayed: medium skin tone";
...
is Uni.new(0x1F590, 0x1F3FE).Str.chars, 1, "Codes: ⟅0x1F590, 0x1F3FE⟆ 🖐🏾 raised hand with fingers splayed: medium-dark skin tone";
## 1F590 1F3FF                                ; fully-qualified     # 🖐🏿 raised hand with fingers splayed: dark skin tone # emoji-test.txt line #1595 Emoji version 4.0
is Uni.new(0x1F590, 0x1F3FF).Str.chars, 1, "Codes: ⟅0x1F590, 0x1F3FF⟆ 🖐🏿 raised hand with fingers splayed: dark skin tone";
...
is Uni.new(0x1F3D8, 0xFE0F).Str.chars, 1, "Codes: ⟅0x1F3D8, 0xFE0F⟆ 🏘️ house";
...
is Uni.new(0x1F1E8, 0x1F1FF).Str.chars, 1, "Codes: ⟅0x1F1E8, 0x1F1FF⟆ 🇨🇿 Czech Republic";
