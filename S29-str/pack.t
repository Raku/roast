...
is(unpack("%32B*", "\001\002\004\010\020\040\100\200\377"), 16 );
is(unpack("%32b69", "\001\002\004\010\020\040\100\200\017"), 12 );
is(unpack("%32B69", "\001\002\004\010\020\040\100\200\017"), 9 );
...
# the whole file was picked up from t/op/pack.t in the perl 5 source
# as pack/unpack should be identical in Perl 6
# the rest of the tests could be adopted as well:
