...
ok(!( "\c[CANADIAN SYLLABICS E]" ~~ m/^<:!CanadianAboriginal>$/ ), q{Don't match negated <CanadianAboriginal>} );
ok(!( "\c[CANADIAN SYLLABICS E]" ~~ m/^<-:CanadianAboriginal>$/ ), q{Don't match inverted <CanadianAboriginal>} );
