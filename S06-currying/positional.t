...
is-primed-sig(sub ($a is parcel) { }, :(), 1);
is-primed-sig(sub ($a is parcel = 4, $b is parcel = 4) { }, :($b? is parcel), 1);
is-primed-sig(sub ($a is parcel where { True }, $b is parcel where { True }) { }, :($b is parcel), 1);
is-primed-sig(sub ($a is parcel where { True } = 4, $b is parcel where { True } = 2) { }, :($b? is parcel), 1);
...
is-primed-sig(sub ($ is parcel) { }, :(), 1);
is-primed-sig(sub ($ is parcel = 4, $ is parcel = 4) { }, :($? is parcel), 1);
is-primed-sig(sub ($ is parcel where { True }, $ is parcel where { True }) { }, :($ is parcel), 1);
is-primed-sig(sub ($ is parcel where { True } = 4, $ is parcel where { True } = 2) { }, :($? is parcel), 1);
