...
throws-like 'class { has Int:U $.a = 42 }.new.a', 
  ...
  name => '$!a', operation => 'assign', 'can Int:U take an Int:D';
...

{
    ...
    throws-like 'use attributes :_; class { has Int:U $.a = 42 }.new', 
      X::TypeCheck::Attribute::Default,
      name => '$!a', operation => 'assign', 'with :_, can Int:U take an Int:D';

    throws-like 'use attributes :_; class { has Int:D $.a }', 
      X::Syntax::Variable::MissingInitializer,
...

{
    ...
    throws-like 'use attributes :U; class { has Int $a = 42 }.new', 
      X::TypeCheck::Attribute::Default,
      name => '$!a', operation => 'assign', 'with :U, can Int   take an Int:D';
    ...
    throws-like 'use attributes :U; class { has Int:U $.a = 42 }.new', 
      X::TypeCheck::Attribute::Default,
      name => '$!a', operation => 'assign', 'with :U, can Int:U take an Int:D';
...

{
    ...
    throws-like 'use attributes :D; class { has Int:U $.a = 42 }.new', 
      X::TypeCheck::Attribute::Default,
      name => '$!a', operation => 'assign', 'with :D, can Int:U take an Int:D';
