...
is sprintf('%5.2e', 3.1415),     "3.14e+00",  '5.2 %e';
is sprintf('%5.2E', 3.1415),     "3.14E+00",  '5.2 %E';
is sprintf('%5.2g', 3.1415e30),   "3.1e+30",  '5.2 %g +30';
is sprintf('%5.2G', 3.1415E30),   "3.1E+30",  '5.2 %G +30';
is sprintf('%5.2g', 3.1415e-30),  "3.1e-30",  '5.2 %g -30';
is sprintf('%5.2G', 3.1415E-30),  "3.1E-30",  '5.2 %G -30';
...
is sprintf('%20.2e', 3.1415),     '            3.14e+00', '20.2 %e';
is sprintf('%20.2E', 3.1415),     '            3.14E+00', '20.2 %E';
is sprintf('%20.2g', 3.1415e30),  '             3.1e+30', '20.2 %g +30';
is sprintf('%20.2G', 3.1415e30),  '             3.1E+30', '20.2 %G +30';
is sprintf('%20.2g', 3.1415e-30), '             3.1e-30', '20.2 %g -30';
is sprintf('%20.2G', 3.1415e-30), '             3.1E-30', '20.2 %G -30';
...
is sprintf('%20.2e', -3.1415),     '           -3.14e+00', 'negative 20.2 %e';
is sprintf('%20.2E', -3.1415),     '           -3.14E+00', 'negative 20.2 %E';
is sprintf('%20.2g', -3.1415e30),  '            -3.1e+30', 'negative 20.2 %g';
is sprintf('%20.2G', -3.1415e30),  '            -3.1E+30', 'negative 20.2 %G';
is sprintf('%20.2g', -3.1415e-30), '            -3.1e-30', 'negative 20.2 %g';
is sprintf('%20.2G', -3.1415e-30), '            -3.1E-30', 'negative 20.2 %G';
...
is sprintf('%020.2e', 3.1415),     '0000000000003.14e+00', '020.2 %e';
is sprintf('%020.2E', 3.1415),     '0000000000003.14E+00', '020.2 %E';
is sprintf('%020.2g', 3.1415e30),  '00000000000003.1e+30', '020.2 %g';
is sprintf('%020.2G', 3.1415e30),  '00000000000003.1E+30', '020.2 %G';
is sprintf('%020.2g', 3.1415e-30), '00000000000003.1e-30', '020.2 %g';
is sprintf('%020.2G', 3.1415e-30), '00000000000003.1E-30', '020.2 %G';
...
is sprintf('%020.2e', -3.1415),     '-000000000003.14e+00', 'negative 020.2 %e';
is sprintf('%020.2E', -3.1415),     '-000000000003.14E+00', 'negative 020.2 %E';
is sprintf('%020.2g', -3.1415e30),  '-0000000000003.1e+30', 'negative 020.2 %g';
is sprintf('%020.2G', -3.1415e30),  '-0000000000003.1E+30', 'negative 020.2 %G';
is sprintf('%020.2g', -3.1415e-30), '-0000000000003.1e-30', 'negative 020.2 %g';
is sprintf('%020.2G', -3.1415e-30), '-0000000000003.1E-30', 'negative 020.2 %G';
...
is sprintf("%x %x", 301281685344656640, 301281685344656669),
