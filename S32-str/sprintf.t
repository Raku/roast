...
is zprintf('%5.2e', 3.1415),   "3.14E+00",  '5.2 %E';
is zprintf('%5.2g', 3.1415e30)  ~~ /^ "3.1e+" "0"? "30" $/, '5.2 %g';
is zprintf('%5.2G', 3.1415e30)  ~~ /^ "3.1E+" "0"? "30" $/, '5.2 %G';
is zprintf('%5.2g', 3.1415e-30) ~~ /^ "3.1e-" "0"? "30" $/, '5.2 %g';
is zprintf('%5.2G', 3.1415e-30) ~~ /^ "3.1E-" "0"? "30" $/, '5.2 %G';
...
ok zprintf('%20.2E', 3.1415)      eq '           3.14E+000' | '            3.14E+00', '20.2 %E';
ok zprintf('%20.2g', 3.1415e30)   eq '           3.14e+030' | '            3.14e+30', '20.2 %g';
ok zprintf('%20.2G', 3.1415e30)   eq '           3.14E+030' | '            3.14E+30', '20.2 %G';
ok zprintf('%20.2g', 3.1415e-30)  eq '           3.14e-030' | '            3.14e-30', '20.2 %g';
ok zprintf('%20.2G', 3.1415e-30)  eq '           3.14E-030' | '            3.14E-30', '20.2 %G';
...
ok zprintf('%20.2E', -3.1415)     eq '          -3.14E+000' | '           -3.14E+00', 'negative 20.2 %E';
ok zprintf('%20.2g', -3.1415e30)  eq '          -3.14e+030' | '           -3.1e+30', 'negative 20.2 %g';
ok zprintf('%20.2G', -3.1415e30)  eq '          -3.14E+030' | '           -3.1E+30', 'negative 20.2 %G';
ok zprintf('%20.2g', -3.1415e-30) eq '          -3.14e-030' | '           -3.1e-30', 'negative 20.2 %g';
ok zprintf('%20.2G', -3.1415e-30) eq '          -3.14E-030' | '           -3.1E-30', 'negative 20.2 %G';
