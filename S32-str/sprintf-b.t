...
#?rakudo 2 todo '"%b" with flag "plus" not correct'
...
#?rakudo todo '"%b" with flag "space" not correct'
...
#?rakudo 2 todo '"%b" with flag "hash" and negative argument not correct'
...
#?rakudo 3 todo '"%b" with flags "zero" and "plus" not correct'
...
#?rakudo todo '"%b" with flags "zero" and "plus" not correct'
is sprintf("%+010b",  9),    "+000001001", '%b; size; flag plus+zero; positive int';
## flags zero and space can be combined
#?rakudo 3 todo '"%b" with flags "zero" and "space" not correct'
...
#?rakudo todo '"%b" with flags "zero" and "space" not correct'
is sprintf("% 010b", -9),    "-000001001", '%b; size; flag space+zero; negative int';
## flags zero and hash can be combined
#?rakudo todo '"%b" with flags "zero" and "hash" not correct'
...
#?rakudo 3 todo '"%b" with flags "zero" and "hash" not correct'
...
#?rakudo 2 todo '"%b" with flags "minus" and "plus" and positiv argument not correct'
...
#?rakudo 2 todo '"%b" with flags "minus" and "space" and positiv argument not correct'
...
#?rakudo skip '"%- 10b" dies with "Unsupported use of %- variable;"'
...
#?rakudo 2 todo '"%b" with flags "minus" and "hash" and negative argument not correct'
...
#?rakudo 2 todo '"%b" with flags "plus" and "space" and positive argument not correct'
...
#?rakudo 5 todo '"%b" with flags "hash" and "plus" not correct'
...
#?rakudo 3 todo '"%b" with flags "hash" and "space" not correct'
...
#?rakudo 2 todo '"%b" with flags "zero", "minus" and "plus" not correct'
...
#?rakudo 2 todo '"%b" with flags "zero", "minus" and "space" not correct'
...
#?rakudo 2 todo '"%b" with flags "zero", "minus" and "hash" not correct'
...
#?rakudo 3 todo '"%b" with flags "zero", "plus" and "space" not correct'
...
#?rakudo skip '"%+ 010b" dies with "unsupported use of %+ variable;"'
is sprintf("%+ 010b", 9),    "+000001001", '%b; size; flag plus+space+zero; positive int';
## flags zero, plus and hash can be combined
#?rakudo 4 todo '"%b" with flags "zero", "plus" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "zero", "space" and "hash" not correct'
...
#?rakudo 2 todo '"%b" with flags "minus", "plus" and "space" and positive argument not correct'
...
#?rakudo 4 todo '"%b" with flags "minus", "plus" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "minus", "space" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "plus", "space" and "hash" not correct'
...
#?rakudo 2 todo '"%b" with flags "zero", "minus", "plus" and "space" not correct'
...
#?rakudo 4 todo '"%b" with flags "zero", "minus", "plus" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "zero", "minus", "space" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "zero", "plus", "space" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "minus", "plus", "space" and "hash" not correct'
...
#?rakudo 4 todo '"%b" with flags "zero", "minus", "plus", "space" and "hash" not correct'
...
#?rakudo todo '"%b" with precision and negative argument not correct'
is sprintf("%10.8b", -9),    " -00001001", '%b; size 10; precision 8; value < 0';
