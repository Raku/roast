...
# tests using runtime size 4 without precision
@info.append( (
       '',  '*',     "   0",     "   1",     " 100",     "-100",
      ' ',  '*',     "   0",     "   1",     " 100",     "-100",
  ...
  '#-+0 ',  '*',     "0   ",     "0b1 ",    "0b100",   "-0b100",
    ...
    @flat.append(
      '%' ~ $_ ~ $size ~ 'b',
      ($r0 => (4,0), $r1 => (4,1), $r4 => (4,4), $rm => (4,-4))
   ) for $flags.comb.permutations>>.join;
   |@flat
} );

# tests without size, using runtime precision 0
@info.append( (
       '', '.*',         "",        "1",      "100",     "-100",
      ' ', '.*',         "",        "1",      "100",     "-100",
      '0', '.*',         "",        "1",      "100",     "-100",
...
@info.append( (
    ...
    '-0 ', "*.*", "000    ", "001    ", "100    ", "-100   ",
   '-+0 ', "*.*", "000    ", "001    ", "100    ", "-100   ",
      '#', "*.*", "    000", "  0b001", "  0b100", " -0b100",
     '# ', "*.*", "    000", "  0b001", "  0b100", " -0b100",
     '#0', "*.*", "    000", "  0b001", "  0b100", " -0b100",
    '#0 ', "*.*", "    000", "  0b001", "  0b100", " -0b100",
     '#+', "*.*", "    000", "  0b001", "  0b100", " -0b100",
    '#+ ', "*.*", "    000", "  0b001", "  0b100", " -0b100",
    '#+0', "*.*", "    000", "  0b001", "  0b100", " -0b100",
  ...
  '#-+0 ', "*.*", "000    ", "0b001  ", "0b100  ", "-0b100 ",
    ...
    @flat.append(
      '%' ~ $_ ~ $size ~ 'b',
      ($r0 => (7,3,0), $r1 => (7,3,1), $r4 => (7,3,4), $rm => (7,3,-4))
   ) for $flags.comb.permutations>>.join;
   |@flat
} );
