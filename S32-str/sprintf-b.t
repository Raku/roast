...
my @info = ( # |-----------|-----------|-----------|-----------|
    ...
    '-0 ',   '',        "0",        "1",      "100",     "-100", $?LINE,
   '-+0 ',   '',        "0",        "1",      "100",     "-100", $?LINE,
      '#',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
     '# ',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
     '#0',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#0 ',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
     '#+',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#+ ',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#+0',   '',        "0",      "0b1",    "0b100",   "-0b100", $?LINE,
  ...
  '#-+0 ', '.0',         "",      "0b1",    "0b100",   "-0b100", $?LINE,
    ...
    '-0 ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
   '-+0 ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
      '#',    2,       " 0",      "0b1",    "0b100",   "-0b100", $?LINE,
     '# ',    2,       " 0",      "0b1",    "0b100",   "-0b100", $?LINE,
     '#0',    2,       "00",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#0 ',    2,       "00",      "0b1",    "0b100",   "-0b100", $?LINE,
     '#+',    2,       " 0",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#+ ',    2,       " 0",      "0b1",    "0b100",   "-0b100", $?LINE,
    '#+0',    2,       "00",      "0b1",    "0b100",   "-0b100", $?LINE,
  ...
  '#-+0 ',    2,       "0 ",      "0b1",    "0b100",   "-0b100", $?LINE,
    ...
    '-0 ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
   '-+0 ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
      '#',    8, "       0", "     0b1", "   0b100", "  -0b100", $?LINE,
     '# ',    8, "       0", "     0b1", "   0b100", "  -0b100", $?LINE,
     '#0',    8, "00000000", "0b000001", "0b000100", "-0b00100", $?LINE,
    '#0 ',    8, "00000000", "0b000001", "0b000100", "-0b00100", $?LINE,
     '#+',    8, "       0", "     0b1", "   0b100", "  -0b100", $?LINE,
    '#+ ',    8, "       0", "     0b1", "   0b100", "  -0b100", $?LINE,
    '#+0',    8, "00000000", "0b000001", "0b000100", "-0b00100", $?LINE,
  ...
  '#-+0 ',    8, "0       ", "0b1     ", "0b100   ", "-0b100  ", $?LINE,
    ...
    '-0 ',  8.2, "00      ", "01      ", "100     ", "-100    ", $?LINE,
   '-+0 ',  8.2, "00      ", "01      ", "100     ", "-100    ", $?LINE,
      '#',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '# ',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '#0',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#0 ',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '#+',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#+ ',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#+0',  8.2, "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
...
@info.append( (
    ...
    '-0 ', "8.*", "00      ", "01      ", "100     ", "-100    ", $?LINE,
   '-+0 ', "8.*", "00      ", "01      ", "100     ", "-100    ", $?LINE,
      '#', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '# ', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '#0', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#0 ', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
     '#+', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#+ ', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
    '#+0', "8.*", "      00", "    0b01", "   0b100", "  -0b100", $?LINE,
