...
my @info = ( # |------------|------------|------------|------------|
       ...
       '',   '',  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
      ' ',   '', " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '0',   '',  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
     '0 ',   '', " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '+',   '', "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+ ',   '', "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+0',   '', "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
  ...
  '#-+0 ', '.0',       "+0.",       "+1.",       "+3.",       "-3.", $?LINE,
       ...
       '',    2,  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
      ' ',    2, " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '0',    2,  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
     '0 ',    2, " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '+',    2, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+ ',    2, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+0',    2, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
   ...
   '-+0 ',    2, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
       ...
       '',    8,  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
      ' ',    8, " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '0',    8,  "0.000000",  "1.000000",  "2.710000", "-2.710000", $?LINE,
     '0 ',    8, " 0.000000", " 1.000000", " 2.710000", "-2.710000", $?LINE,
      '+',    8, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+ ',    8, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
     '+0',    8, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
   ...
   '-+0 ',    8, "+0.000000", "+1.000000", "+2.710000", "-2.710000", $?LINE,
       ...
       '',  8.2,  "    0.00",  "    1.00",  "    2.71",  "   -2.71", $?LINE,
      ' ',  8.2,  "    0.00",  "    1.00",  "    2.71",  "   -2.71", $?LINE,
      '0',  8.2,  "00000.00",  "00001.00",  "00002.71",  "-0002.71", $?LINE,
     '0 ',  8.2,  " 0000.00",  " 0001.00",  " 0002.71",  "-0002.71", $?LINE,
      '+',  8.2,  "   +0.00",  "   +1.00",  "   +2.71",  "   -2.71", $?LINE,
     '+ ',  8.2,  "   +0.00",  "   +1.00",  "   +2.71",  "   -2.71", $?LINE,
     '+0',  8.2,  "+0000.00",  "+0001.00",  "+0002.71",  "-0002.71", $?LINE,
    '+0 ',  8.2,  "+0000.00",  "+0001.00",  "+0002.71",  "-0002.71", $?LINE,
...
@info.append( (
             # 8 positions with precision, precision fits sometimes
       '', "8.*",  "    0.00",  "    1.00",  "    2.71",  "   -2.71", $?LINE,
      ' ', "8.*",  "    0.00",  "    1.00",  "    2.71",  "   -2.71", $?LINE,
      '0', "8.*",  "00000.00",  "00001.00",  "00002.71",  "-0002.71", $?LINE,
     '0 ', "8.*",  " 0000.00",  " 0001.00",  " 0002.71",  "-0002.71", $?LINE,
      '+', "8.*",  "   +0.00",  "   +1.00",  "   +2.71",  "   -2.71", $?LINE,
     '+ ', "8.*",  "   +0.00",  "   +1.00",  "   +2.71",  "   -2.71", $?LINE,
     '+0', "8.*",  "+0000.00",  "+0001.00",  "+0002.71",  "-0002.71", $?LINE,
    '+0 ', "8.*",  "+0000.00",  "+0001.00",  "+0002.71",  "-0002.71", $?LINE,
