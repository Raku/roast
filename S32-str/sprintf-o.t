...
my @info = ( # |-----------|-----------|-----------|-----------|
  ...
  '#-+0 ', '.0',         "",       "01",     "0100",    "-0100", $?LINE,
    ...
    '+0 ',    2,       "00",       "01",      "100",     "-100", $?LINE,
     ...
     '- ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
    '-+ ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
     '-0',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
    '-+0',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
    '-0 ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
   '-+0 ',    2,       "0 ",       "1 ",      "100",     "-100", $?LINE,
      '#',    2,       " 0",       "01",     "0100",    "-0100", $?LINE,
     '# ',    2,       " 0",       "01",     "0100",    "-0100", $?LINE,
     '#0',    2,       "00",       "01",     "0100",    "-0100", $?LINE,
    '#0 ',    2,       "00",       "01",     "0100",    "-0100", $?LINE,
     '#+',    2,       " 0",       "01",     "0100",    "-0100", $?LINE,
    '#+ ',    2,       " 0",       "01",     "0100",    "-0100", $?LINE,
    '#+0',    2,       "00",       "01",     "0100",    "-0100", $?LINE,
  ...
  '#-+0 ',    2,       "0 ",       "01",     "0100",    "-0100", $?LINE,
       ...
       '',    8, "       0", "       1", "     100", "    -100", $?LINE,
      ' ',    8, "       0", "       1", "     100", "    -100", $?LINE,
      '0',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
     '0 ',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
      '+',    8, "       0", "       1", "     100", "    -100", $?LINE,
     '+ ',    8, "       0", "       1", "     100", "    -100", $?LINE,
     '+0',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
    '+0 ',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
     ...
     '- ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
    '-+ ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
     '-0',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
    '-+0',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
    '-0 ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
   '-+0 ',    8, "0       ", "1       ", "100     ", "-100    ", $?LINE,
      '#',    8, "       0", "      01", "    0100", "   -0100", $?LINE,
     '# ',    8, "       0", "      01", "    0100", "   -0100", $?LINE,
     '#0',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
    '#0 ',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
     '#+',    8, "       0", "      01", "    0100", "   -0100", $?LINE,
   ...
   '#+0 ',    8, "00000000", "00000001", "00000100", "-0000100", $?LINE,
    ...
    '#- ',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,
   '#-+ ',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,
    '#-0',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,
   '#-+0',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,
   '#-0 ',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,
  '#-+0 ',    8, "0       ", "01      ", "0100    ", "-0100   ", $?LINE,

             # 8 positions with precision, precision fits sometimes
       '',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
      ' ',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
      '0',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
     '0 ',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
      '+',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
     '+ ',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
     '+0',  8.2, "      00", "      01", "     100", "    -100", $?LINE,
    ...
    '-0 ',  8.2, "00      ", "01      ", "100     ", "-100    ", $?LINE,
   '-+0 ',  8.2, "00      ", "01      ", "100     ", "-100    ", $?LINE,
      '#',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
     '# ',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
     '#0',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
    '#0 ',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
     '#+',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
    '#+ ',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
    '#+0',  8.2, "      00", "      01", "    0100", "   -0100", $?LINE,
...
).map: -> $flags, $size, $r0, $r1, $r4, $rm, $line {
    my @flat;
    @flat.append(
      $line,
      '%' ~ $_ ~ $size ~ 'o',
...
@info.append( (
             # 8 positions with precision, precision fits sometimes
       '', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
      ' ', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
      '0', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
     '0 ', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
      '+', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
     '+ ', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
     '+0', "8.*", "      00", "      01", "     100", "    -100", $?LINE,
    ...
    '-0 ', "8.*", "00      ", "01      ", "100     ", "-100    ", $?LINE,
   '-+0 ', "8.*", "00      ", "01      ", "100     ", "-100    ", $?LINE,
      '#', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
     '# ', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
     '#0', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
    '#0 ', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
     '#+', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
    '#+ ', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
    '#+0', "8.*", "      00", "      01", "    0100", "   -0100", $?LINE,
