...
my @info = ( # |-----------|-----------|-----------|-----------|
   ...
   '-+0 ', '.0',        "+",       "+1",     "+314",     "-314", $?LINE,
       ...
       '',    2,       " 0",       " 1",      "314",     "-314", $?LINE,
      ' ',    2,       " 0",       " 1",     " 314",     "-314", $?LINE,
      '0',    2,       "00",       "01",      "314",     "-314", $?LINE,
     '0 ',    2,       " 0",       " 1",     " 314",     "-314", $?LINE,
      '+',    2,       "+0",       "+1",     "+314",     "-314", $?LINE,
     '+ ',    2,       "+0",       "+1",     "+314",     "-314", $?LINE,
     '+0',    2,       "+0",       "+1",     "+314",     "-314", $?LINE,
    '+0 ',    2,       "+0",       "+1",     "+314",     "-314", $?LINE,
   ...
   '-+0 ',    2,       "+0",       "+1",     "+314",     "-314", $?LINE,
       ...
       '',    8, "       0", "       1", "     314", "    -314", $?LINE,
      ' ',    8, "       0", "       1", "     314", "    -314", $?LINE,
      '0',    8, "00000000", "00000001", "00000314", "-0000314", $?LINE,
     '0 ',    8, " 0000000", " 0000001", " 0000314", "-0000314", $?LINE,
      '+',    8, "      +0", "      +1", "    +314", "    -314", $?LINE,
     '+ ',    8, "      +0", "      +1", "    +314", "    -314", $?LINE,
     '+0',    8, "+0000000", "+0000001", "+0000314", "-0000314", $?LINE,
    '+0 ',    8, "+0000000", "+0000001", "+0000314", "-0000314", $?LINE,
     ...
     '- ',    8, " 0      ", " 1      ", " 314    ", "-314    ", $?LINE,
    '-+ ',    8, "+0      ", "+1      ", "+314    ", "-314    ", $?LINE,
     '-0',    8, "0       ", "1       ", "314     ", "-314    ", $?LINE,
    '-+0',    8, "+0      ", "+1      ", "+314    ", "-314    ", $?LINE,
    '-0 ',    8, " 0      ", " 1      ", " 314    ", "-314    ", $?LINE,
   '-+0 ',    8, "+0      ", "+1      ", "+314    ", "-314    ", $?LINE,

             # 8 positions with precision, precision fits sometimes
       '',  8.2, "      00", "      01", "     314", "    -314", $?LINE,
      ' ',  8.2, "      00", "      01", "     314", "    -314", $?LINE,
      '0',  8.2, "      00", "      01", "     314", "    -314", $?LINE,
     '0 ',  8.2, "      00", "      01", "     314", "    -314", $?LINE,
      '+',  8.2, "     +00", "     +01", "    +314", "    -314", $?LINE,
     '+ ',  8.2, "     +00", "     +01", "    +314", "    -314", $?LINE,
     '+0',  8.2, "     +00", "     +01", "    +314", "    -314", $?LINE,
...
@info.append( (
             # 8 positions with precision, precision fits sometimes
       '', '8.*', "      00", "      01", "     314", "    -314", $?LINE,
      ' ', '8.*', "      00", "      01", "     314", "    -314", $?LINE,
      '0', '8.*', "      00", "      01", "     314", "    -314", $?LINE,
     '0 ', '8.*', "      00", "      01", "     314", "    -314", $?LINE,
      '+', '8.*', "     +00", "     +01", "    +314", "    -314", $?LINE,
     '+ ', '8.*', "     +00", "     +01", "    +314", "    -314", $?LINE,
     '+0', '8.*', "     +00", "     +01", "    +314", "    -314", $?LINE,
