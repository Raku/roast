...
#?rakudo skip '[\...] meta ops'
{
    ...
    is (~ [\<]  1, 3, 2, 4), "1 1 0 1", "[\\<] works (2)";
    is (~ [\>]  4, 3, 2, 1), "1 1 1 1", "[\\>] works (1)";
    is (~ [\>]  4, 2, 3, 1), "1 1 0 1", "[\\>] works (2)";
    is (~ [\==]  4, 4, 4),   "1 1 1",   "[\\==] works (1)";
    is (~ [\==]  4, 5, 4),   "1 0 0",   "[\\==] works (2)";
    is (~ [\==]  1, 2, 2, 1),"1 0 1 0",   "[\\==] works with short-circuting operators";
    is (~ [\!=]  4, 5, 6),   "0 1 1",   "[\\!=] works (1)";
    is (~ [\!=]  4, 5, 5),   "0 1 0",   "[\\!=] works (2)";
