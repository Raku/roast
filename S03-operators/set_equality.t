...
# equality with itself should always be True
my @identities =
...
# equality comparisons that should be True
my @ok =
...
#exit dd $right, $left, $name, True unless
        is-deeply op($right,$left), True,
          "$right.^name() $name $left";
    }
...
#exit dd $right, $left, $name, False unless
