...
is (1, { $_ + 2 } ... 9).join(', '), '1, 3, 5, 7, 9', 'simple series with one item and closure on the LHS';
...
is (1, { -$_ } ... 1).join(', '), '1', 'simple repeating series with one item and closure on the LHS';
...
is (1, { $_ + 2 } ... 10).join(', '), '1, 3, 5, 7, 9', 'simple series with one item and closure on the LHS';
...
is (1, { -$_ } ... 0).join(', '), '1', 'simple repeating series with one item and closure on the LHS';
...
is (4, 2, 1, 2, 4 ... 16).join(', '), '4, 2, 1, 2, 4, 8, 16', 'series started with three identical numbers, but then goes geometric';
