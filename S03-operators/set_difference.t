...
my @triplets =
  ...
  <a b>.SetHash,             <c d>.SetHash,     <a b>.SetHash,
  <a b c>.SetHash,           <b c d>.SetHash,   <a>.SetHash,
  ...
  MixHash.new,               <a b>.MixHash, (a=>-1,b=>-1).MixHash,
  ...
  <a b>.SetHash,             <a b b>.BagHash,   BagHash.new,
  <a b b>.Bag,               <a b>.Set,         <b>.Bag,
  <a b b>.BagHash,           <a b>.SetHash,     <b>.BagHash,

  <a b>.Set,                 <a b b>.Mix,       (b=>-1).Mix,
  <a b>.SetHash,             <a b b>.MixHash,   (b=>-1).MixHash,
  <a b b>.Mix,               <a b>.Set,         <b>.Mix,
  <a b b>.MixHash,           <a b>.SetHash,     <b>.MixHash,

  <a b>.Set,                 (b=>-1).Mix,       <a b b>.Mix,
  <a b>.SetHash,             (b=>-1).MixHash,   <a b b>.MixHash,
  (b=>-1).Mix,               <a b>.Set,         (a=>-1,b=>-2).Mix,
  (b=>-1).MixHash,           <a b>.SetHash,     (a=>-1,b=>-2).MixHash,

  <a b>.Bag,                 <a b b>.Mix,       (b=>-1).Mix,
  <a b>.BagHash,             <a b b>.MixHash,   (b=>-1).MixHash,
  <a b>.Mix,                 <a b b>.Bag,       (b=>-1).Mix,
  <a b>.MixHash,             <a b b>.BagHash,   (b=>-1).MixHash,

  <a b>.Bag,                 (b=>-1).Mix,       <a b b>.Mix,
  <a b>.BagHash,             (b=>-1).MixHash,   <a b b>.MixHash,
  (b=>-1).Mix,               <a b b>.Bag,       (a=>-1,b=>-3).Mix,
  (b=>-1).MixHash,           <a b b>.BagHash,   (a=>-1,b=>-3).MixHash,

  <a b c>.Set,               {:42a,:0b},        <b c>.Set,
  <a b c>.SetHash,           {:42a,:0b},        <b c>.SetHash,
  <a b b c>.Bag,             {:42a,:0b},        <b b c>.Bag,
  <a b b c>.BagHash,         {:42a,:0b},        <b b c>.BagHash,
  <a b b c>.Mix,             {:42a,:0b},        <b b c>.Mix,
  <a b b c>.MixHash,         {:42a,:0b},        <b b c>.MixHash,
  ...
  <a b c>.SetHash,           <a b c d>,         SetHash.new,
  <a b b c>.Bag,             <a b c d>,         <b>.Bag,
  <a b b c>.BagHash,         <a b c d>,         <b>.BagHash,
  <a b b c>.Mix,             <a b c d>,         (b=>1,d=>-1).Mix,
  <a b b c>.MixHash,         <a b c d>,         (b=>1,d=>-1).MixHash,
...
plan 1 * (1 + 3 * @types + @pairs/2 + @triplets/3 + @quads/2);
