...
ok Uni.new(0x105C9).NFKC.list ~~ (0x105C9,), '105C9 -> 105C9';
ok Uni.new(0x105E4).NFKC.list ~~ (0x105E4,), '105E4 -> 105E4';
...
ok Uni.new(0x11383).NFKC.list ~~ (0x11383,), '11383 -> 11383';
ok Uni.new(0x11385).NFKC.list ~~ (0x11385,), '11385 -> 11385';
ok Uni.new(0x1138E).NFKC.list ~~ (0x1138E,), '1138E -> 1138E';
ok Uni.new(0x11391).NFKC.list ~~ (0x11391,), '11391 -> 11391';
ok Uni.new(0x113C5).NFKC.list ~~ (0x113C5,), '113C5 -> 113C5';
ok Uni.new(0x113C7).NFKC.list ~~ (0x113C7,), '113C7 -> 113C7';
ok Uni.new(0x113C8).NFKC.list ~~ (0x113C8,), '113C8 -> 113C8';
...
ok Uni.new(0x16121).NFKC.list ~~ (0x16121,), '16121 -> 16121';
ok Uni.new(0x16122).NFKC.list ~~ (0x16122,), '16122 -> 16122';
ok Uni.new(0x16123).NFKC.list ~~ (0x16123,), '16123 -> 16123';
ok Uni.new(0x16124).NFKC.list ~~ (0x16124,), '16124 -> 16124';
ok Uni.new(0x16125).NFKC.list ~~ (0x16125,), '16125 -> 16125';
ok Uni.new(0x16126).NFKC.list ~~ (0x16126,), '16126 -> 16126';
ok Uni.new(0x16127).NFKC.list ~~ (0x16127,), '16127 -> 16127';
ok Uni.new(0x16128).NFKC.list ~~ (0x16128,), '16128 -> 16128';
...
ok Uni.new(0x1CCD9).NFKC.list ~~ (0x0044,), '1CCD9 -> 0044';
ok Uni.new(0x1CCDA).NFKC.list ~~ (0x0045,), '1CCDA -> 0045';
ok Uni.new(0x1CCDB).NFKC.list ~~ (0x0046,), '1CCDB -> 0046';
ok Uni.new(0x1CCDC).NFKC.list ~~ (0x0047,), '1CCDC -> 0047';
ok Uni.new(0x1CCDD).NFKC.list ~~ (0x0048,), '1CCDD -> 0048';
ok Uni.new(0x1CCDE).NFKC.list ~~ (0x0049,), '1CCDE -> 0049';
ok Uni.new(0x1CCDF).NFKC.list ~~ (0x004A,), '1CCDF -> 004A';
ok Uni.new(0x1CCE0).NFKC.list ~~ (0x004B,), '1CCE0 -> 004B';
ok Uni.new(0x1CCE1).NFKC.list ~~ (0x004C,), '1CCE1 -> 004C';
ok Uni.new(0x1CCE2).NFKC.list ~~ (0x004D,), '1CCE2 -> 004D';
ok Uni.new(0x1CCE3).NFKC.list ~~ (0x004E,), '1CCE3 -> 004E';
ok Uni.new(0x1CCE4).NFKC.list ~~ (0x004F,), '1CCE4 -> 004F';
ok Uni.new(0x1CCE5).NFKC.list ~~ (0x0050,), '1CCE5 -> 0050';
ok Uni.new(0x1CCE6).NFKC.list ~~ (0x0051,), '1CCE6 -> 0051';
ok Uni.new(0x1CCE7).NFKC.list ~~ (0x0052,), '1CCE7 -> 0052';
ok Uni.new(0x1CCE8).NFKC.list ~~ (0x0053,), '1CCE8 -> 0053';
ok Uni.new(0x1CCE9).NFKC.list ~~ (0x0054,), '1CCE9 -> 0054';
ok Uni.new(0x1CCEA).NFKC.list ~~ (0x0055,), '1CCEA -> 0055';
ok Uni.new(0x1CCEB).NFKC.list ~~ (0x0056,), '1CCEB -> 0056';
ok Uni.new(0x1CCEC).NFKC.list ~~ (0x0057,), '1CCEC -> 0057';
ok Uni.new(0x1CCED).NFKC.list ~~ (0x0058,), '1CCED -> 0058';
ok Uni.new(0x1CCEE).NFKC.list ~~ (0x0059,), '1CCEE -> 0059';
ok Uni.new(0x1CCEF).NFKC.list ~~ (0x005A,), '1CCEF -> 005A';
ok Uni.new(0x1CCF0).NFKC.list ~~ (0x0030,), '1CCF0 -> 0030';
ok Uni.new(0x1CCF1).NFKC.list ~~ (0x0031,), '1CCF1 -> 0031';
ok Uni.new(0x1CCF2).NFKC.list ~~ (0x0032,), '1CCF2 -> 0032';
ok Uni.new(0x1CCF3).NFKC.list ~~ (0x0033,), '1CCF3 -> 0033';
ok Uni.new(0x1CCF4).NFKC.list ~~ (0x0034,), '1CCF4 -> 0034';
ok Uni.new(0x1CCF5).NFKC.list ~~ (0x0035,), '1CCF5 -> 0035';
ok Uni.new(0x1CCF6).NFKC.list ~~ (0x0036,), '1CCF6 -> 0036';
ok Uni.new(0x1CCF7).NFKC.list ~~ (0x0037,), '1CCF7 -> 0037';
ok Uni.new(0x1CCF8).NFKC.list ~~ (0x0038,), '1CCF8 -> 0038';
ok Uni.new(0x1CCF9).NFKC.list ~~ (0x0039,), '1CCF9 -> 0039';
