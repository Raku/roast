...
ok Uni.new(0x3307, 0x0334).NFD.list ~~ (0x3307, 0x0334,), '3307 0334 -> 3307 0334';
ok Uni.new(0x3310, 0x0334).NFD.list ~~ (0x3310, 0x0334,), '3310 0334 -> 3310 0334';
ok Uni.new(0x331E, 0x0334).NFD.list ~~ (0x331E, 0x0334,), '331E 0334 -> 331E 0334';
ok Uni.new(0x3321, 0x0334).NFD.list ~~ (0x3321, 0x0334,), '3321 0334 -> 3321 0334';
ok Uni.new(0x3332, 0x0334).NFD.list ~~ (0x3332, 0x0334,), '3332 0334 -> 3332 0334';
ok Uni.new(0x333B, 0x0334).NFD.list ~~ (0x333B, 0x0334,), '333B 0334 -> 333B 0334';
ok Uni.new(0x3340, 0x0334).NFD.list ~~ (0x3340, 0x0334,), '3340 0334 -> 3340 0334';
ok Uni.new(0x334B, 0x0334).NFD.list ~~ (0x334B, 0x0334,), '334B 0334 -> 334B 0334';
ok Uni.new(0x334E, 0x0334).NFD.list ~~ (0x334E, 0x0334,), '334E 0334 -> 334E 0334';
ok Uni.new(0xFEF5, 0x0656).NFD.list ~~ (0xFEF5, 0x0656,), 'FEF5 0656 -> FEF5 0656';
ok Uni.new(0xFEF6, 0x0656).NFD.list ~~ (0xFEF6, 0x0656,), 'FEF6 0656 -> FEF6 0656';
ok Uni.new(0xFEF7, 0x0656).NFD.list ~~ (0xFEF7, 0x0656,), 'FEF7 0656 -> FEF7 0656';
ok Uni.new(0xFEF8, 0x0656).NFD.list ~~ (0xFEF8, 0x0656,), 'FEF8 0656 -> FEF8 0656';
ok Uni.new(0xFEF9, 0x0334).NFD.list ~~ (0xFEF9, 0x0334,), 'FEF9 0334 -> FEF9 0334';
ok Uni.new(0xFEFA, 0x0334).NFD.list ~~ (0xFEFA, 0x0334,), 'FEFA 0334 -> FEFA 0334';
