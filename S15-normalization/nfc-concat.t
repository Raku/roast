...
@list = 0x0061, 0x059A, 0x0316, 0x302A, 0x1ABF, 0x0062; @result = 0x0061, 0x302A, 0x0316, 0x1ABF, 0x059A, 0x0062; 
ok all(((Uni.new(@list[0..($_ - 1)]) ~ Uni.new(@list[$_..*])).NFC.list ~~ @result for 1..(@list-1))), '0x0061, 0x059A, 0x0316, 0x302A, 0x1ABF, 0x0062 -> 0x0061, 0x302A, 0x0316, 0x1ABF, 0x059A, 0x0062 CONCAT';
@list = 0x0061, 0x1ABF, 0x059A, 0x0316, 0x302A, 0x0062; @result = 0x0061, 0x302A, 0x1ABF, 0x0316, 0x059A, 0x0062; 
ok all(((Uni.new(@list[0..($_ - 1)]) ~ Uni.new(@list[$_..*])).NFC.list ~~ @result for 1..(@list-1))), '0x0061, 0x1ABF, 0x059A, 0x0316, 0x302A, 0x0062 -> 0x0061, 0x302A, 0x1ABF, 0x0316, 0x059A, 0x0062 CONCAT';
@list = 0x0061, 0x059A, 0x0316, 0x302A, 0x1AC0, 0x0062; @result = 0x0061, 0x302A, 0x0316, 0x1AC0, 0x059A, 0x0062; 
ok all(((Uni.new(@list[0..($_ - 1)]) ~ Uni.new(@list[$_..*])).NFC.list ~~ @result for 1..(@list-1))), '0x0061, 0x059A, 0x0316, 0x302A, 0x1AC0, 0x0062 -> 0x0061, 0x302A, 0x0316, 0x1AC0, 0x059A, 0x0062 CONCAT';
@list = 0x0061, 0x1AC0, 0x059A, 0x0316, 0x302A, 0x0062; @result = 0x0061, 0x302A, 0x1AC0, 0x0316, 0x059A, 0x0062; 
ok all(((Uni.new(@list[0..($_ - 1)]) ~ Uni.new(@list[$_..*])).NFC.list ~~ @result for 1..(@list-1))), '0x0061, 0x1AC0, 0x059A, 0x0316, 0x302A, 0x0062 -> 0x0061, 0x302A, 0x1AC0, 0x0316, 0x059A, 0x0062 CONCAT';
