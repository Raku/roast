...
# https://github.com/Raku/old-issue-tracker/issues/3501
#?rakudo todo ""
is ~$dt, '2007-01-01T21:22:00-05:00', 'DateTime.in-timezone($*TZ) (from UTC, outside of DST)';

$dt = ds('2007-01-02T02:22:00Z').local;
# https://github.com/Raku/old-issue-tracker/issues/3501
#?rakudo todo ""
is ~$dt, '2007-01-01T21:22:00-05:00', 'DateTime.local (from UTC, outside of DST)';
$dt = ds('2003-08-01T02:22:00Z').local;
is ~$dt, '2003-07-31T22:22:00-04:00', 'DateTime.local (from UTC, during DST)';
$dt = ds('1984-04-29T06:55:00Z').local;
# https://github.com/Raku/old-issue-tracker/issues/3501
#?rakudo todo ""
is ~$dt, '1984-04-29T01:55:00-05:00', 'DateTime.local (from UTC, just before DST begins)';
...
# https://github.com/Raku/old-issue-tracker/issues/3501
#?rakudo todo ""
is ~$dt, '2008-11-02T01:55:00-05:00', 'DateTime.local (from -1612, just after DST ends)';
...
is ~$dt, '2007-03-10T14:50:00-16:12', 'DateTime.in-timezone (local to -1612, just after DST starts)';
...
# https://github.com/Raku/old-issue-tracker/issues/3501
#?rakudo todo ""
is ~$dt, '1998-12-31T18:59:60-05:00', 'DateTime.local (from UTC, with leap second)';
