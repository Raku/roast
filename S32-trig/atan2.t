...
is_approx(atan2((1).Num, (1).Num), 0.785398163397448, "atan2(Num, Num)");
is_approx(atan2(:y((10).Num), :x((10).Num)), 0.785398163397448, "atan2(:y(Num), :x(Num))");

# Num vs Rat tests
is_approx((-1).Num.atan2((-10).Rat(1e-9)), -3.04192400109863, "Num.atan2(Rat)");
is_approx(atan2((-100).Num, (-0.1).Rat(1e-9)), -1.57179632646156, "atan2(Num, Rat)");
is_approx(atan2(:y((-0.1).Num), :x((0.1).Rat(1e-9))), -0.785398163397448, "atan2(:y(Num), :x(Rat))");

# Num vs Int tests
is_approx((-0.1).Num.atan2((-10).Int), -3.13159298690313, "Num.atan2(Int)");
is_approx(atan2((0.1).Num, (-1).Int), 3.04192400109863, "atan2(Num, Int)");
is_approx(atan2(:y((-10).Num), :x((-1).Int)), -1.67046497928606, "atan2(:y(Num), :x(Int))");

# Num vs Str tests
is_approx((1).Num.atan2((-10).Str), 3.04192400109863, "Num.atan2(Str)");
...
is_approx(atan2((-0.1).Num, DifferentReal.new(-100)), -3.14059265392313, "atan2(Num, DifferentReal)");
...
# Rat vs Num tests
is_approx((-1).Rat(1e-9).atan2((10).Num), -0.099668652491162, "Rat.atan2(Num)");
is_approx(atan2((100).Rat(1e-9), (100).Num), 0.785398163397448, "atan2(Rat, Num)");
is_approx(atan2(:y((1).Rat(1e-9)), :x((0.1).Num)), 1.47112767430373, "atan2(:y(Rat), :x(Num))");

# Rat vs Rat tests
is_approx((-10).Rat(1e-9).atan2((1).Rat(1e-9)), -1.47112767430373, "Rat.atan2(Rat)");
is_approx(atan2((-100).Rat(1e-9), (-100).Rat(1e-9)), -2.35619449019234, "atan2(Rat, Rat)");
is_approx(atan2(:y((-1).Rat(1e-9)), :x((-100).Rat(1e-9))), -3.13159298690313, "atan2(:y(Rat), :x(Rat))");

# Rat vs Int tests
is_approx((10).Rat(1e-9).atan2((-100).Int), 3.04192400109863, "Rat.atan2(Int)");
is_approx(atan2((1).Rat(1e-9), (-10).Int), 3.04192400109863, "atan2(Rat, Int)");
is_approx(atan2(:y((1).Rat(1e-9)), :x((-10).Int)), 3.04192400109863, "atan2(:y(Rat), :x(Int))");

# Rat vs Str tests
is_approx((-1).Rat(1e-9).atan2((-10).Str), -3.04192400109863, "Rat.atan2(Str)");
is_approx(atan2((10).Rat(1e-9), (0.1).Str), 1.56079666010823, "atan2(Rat, Str)");
is_approx(atan2(:y((-10).Rat(1e-9)), :x((-0.1).Str)), -1.58079599348156, "atan2(:y(Rat), :x(Str))");

# Rat vs DifferentReal tests
is_approx((100).Rat(1e-9).atan2(DifferentReal.new(100)), 0.785398163397448, "Rat.atan2(DifferentReal)");
is_approx(atan2((0.1).Rat(1e-9), DifferentReal.new(-0.1)), 2.35619449019234, "atan2(Rat, DifferentReal)");
is_approx(atan2(:y((-100).Rat(1e-9)), :x(DifferentReal.new(10))), -1.47112767430373, "atan2(:y(Rat), :x(DifferentReal))");
...
is_approx(atan2((1).Int, (0.1).Num), 1.47112767430373, "atan2(Int, Num)");
is_approx(atan2(:y((-10).Int), :x((-1).Num)), -1.67046497928606, "atan2(:y(Int), :x(Num))");

# Int vs Rat tests
is_approx((-10).Int.atan2((-0.1).Rat(1e-9)), -1.58079599348156, "Int.atan2(Rat)");
is_approx(atan2((1).Int, (-0.1).Rat(1e-9)), 1.67046497928606, "atan2(Int, Rat)");
is_approx(atan2(:y((10).Int), :x((100).Rat(1e-9))), 0.099668652491162, "atan2(:y(Int), :x(Rat))");

# Int vs Int tests
is_approx((1).Int.atan2((100).Int), 0.00999966668666524, "Int.atan2(Int)");
is_approx(atan2((-1).Int, (-1).Int), -2.35619449019234, "atan2(Int, Int)");
is_approx(atan2(:y((-10).Int), :x((1).Int)), -1.47112767430373, "atan2(:y(Int), :x(Int))");

# Int vs Str tests
is_approx((100).Int.atan2((-0.1).Str), 1.57179632646156, "Int.atan2(Str)");
is_approx(atan2((-10).Int, (1).Str), -1.47112767430373, "atan2(Int, Str)");
is_approx(atan2(:y((1).Int), :x((-10).Str)), 3.04192400109863, "atan2(:y(Int), :x(Str))");

# Int vs DifferentReal tests
is_approx((100).Int.atan2(DifferentReal.new(0.1)), 1.56979632712823, "Int.atan2(DifferentReal)");
...
# Str vs Num tests
is_approx((1).Str.atan2((-0.1).Num), 1.67046497928606, "Str.atan2(Num)");
is_approx(atan2((-100).Str, (0.1).Num), -1.56979632712823, "atan2(Str, Num)");
is_approx(atan2(:y((100).Str), :x((-10).Num)), 1.67046497928606, "atan2(:y(Str), :x(Num))");

# Str vs Rat tests
is_approx((-100).Str.atan2((0.1).Rat(1e-9)), -1.56979632712823, "Str.atan2(Rat)");
...
is_approx(atan2((-1).Str, (1).Int), -0.785398163397448, "atan2(Str, Int)");
is_approx(atan2(:y((-0.1).Str), :x((-100).Int)), -3.14059265392313, "atan2(:y(Str), :x(Int))");

# Str vs Str tests
is_approx((0.1).Str.atan2((10).Str), 0.00999966668666524, "Str.atan2(Str)");
...
is_approx(atan2(:y(DifferentReal.new(-0.1)), :x((-1).Num)), -3.04192400109863, "atan2(:y(DifferentReal), :x(Num))");
...
is_approx(atan2(:y(DifferentReal.new(-1)), :x((10).Rat(1e-9))), -0.099668652491162, "atan2(:y(DifferentReal), :x(Rat))");

# DifferentReal vs Int tests
is_approx(DifferentReal.new(100).atan2((-1).Int), 1.58079599348156, "DifferentReal.atan2(Int)");
is_approx(atan2(DifferentReal.new(-10), (10).Int), -0.785398163397448, "atan2(DifferentReal, Int)");
is_approx(atan2(:y(DifferentReal.new(1)), :x((-100).Int)), 3.13159298690313, "atan2(:y(DifferentReal), :x(Int))");

# DifferentReal vs Str tests
is_approx(DifferentReal.new(10).atan2((-10).Str), 2.35619449019234, "DifferentReal.atan2(Str)");
is_approx(atan2(DifferentReal.new(-0.1), (100).Str), -0.000999999666666867, "atan2(DifferentReal, Str)");
is_approx(atan2(:y(DifferentReal.new(-0.1)), :x((-100).Str)), -3.14059265392313, "atan2(:y(DifferentReal), :x(Str))");

# DifferentReal vs DifferentReal tests
is_approx(DifferentReal.new(-1).atan2(DifferentReal.new(100)), -0.00999966668666524, "DifferentReal.atan2(DifferentReal)");
